...
#         https://github.com/diskuv/dkml-installer-opam/releases).
...
GHREPO=diskuv/dkml-installer-opam
...
printf "\n\n\nCongratulations!\n" >&2
printf "Go to https://github.com/diskuv/dkml-installer-opam/releases/edit/%s\n" "$RELEASE_TAG" >&2
